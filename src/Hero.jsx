...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative flex flex-col items-center justify-center min-h-screen text-center overflow-hidden px-4 mt-[-4rem]">
      ...
      <div className="relative z-10 flex flex-col items-center w-full">
        <motion.h1
          className="text-[8rem] md:text-[10rem] lg:text-[12rem] font-black tracking-tighter bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent leading-none mt-[-4rem] mb-0 px-8 inline-block mx-auto select-none"
